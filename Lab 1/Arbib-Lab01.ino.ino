...
const int stepTime = 3600; //delay time between high and low on step pin
...
void setup()
{
  ...
  stepperRight.setAcceleration(3000);//set desired acceleration in steps/s^2
  ...
  stepperLeft.setAcceleration(3000);//set desired acceleration in steps/s^2

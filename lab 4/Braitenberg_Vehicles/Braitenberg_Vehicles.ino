...
void setup() {
  ...
  pinMode(lfPhotoResist, INPUT);
  pinMode(rtPhotoResist, INPUT);
...
void loop() {
  ...
  //  left = analogRead(lfPhotoResist);
  //  right = analogRead(rtPhotoResist);
